...
import { useRelatoriosControllerRankingMdrVendedores } from "@/gen"
...
export function RankingVendedoresChart({ start_date, finish_date }: { start_date: string; finish_date: string }) {
  const { data: rankingVendedores } = useRelatoriosControllerRankingMdrVendedores({
    finish_date,
    start_date,
  })
  ...
  const sortedData = useMemo(() => {
    if (!rankingVendedores?.data) return []

    return [...rankingVendedores.data]
