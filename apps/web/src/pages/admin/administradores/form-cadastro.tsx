...
const cadastroSchema = z.object({
  ...
  telefone: z
    ...
    .regex(/^[\d\s\-()]+$/, {
      message:
        "O telefone deve conter apenas números, espaços, hífens e parênteses.",
    }),
  senha: z
    .string()
    .min(6, { message: "A senha deve ter no mínimo 6 caracteres." }),
  role: z.enum(["ADMINISTRADOR", "GESTOR", "VENDEDOR"]),
});
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormItem>
                  ...
                  >
                    <FormControl className="w-full">
                      <SelectTrigger>
                        <SelectValue placeholder="Escolha o papel do usuário" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
            ...
            {error && (
              <Alert variant="destructive">
                <AlertCircleIcon />
                <AlertTitle>
                  Não foi possível cadastrar administrador.
                </AlertTitle>
                <AlertDescription>
